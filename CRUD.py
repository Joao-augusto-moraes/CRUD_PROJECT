...
def salvar(lista: list, nome_arquivo: str) -> None:
...
class Repositorio:
    ...
    def __init__(self, arquivo: str, campo_id: str, label: str, campos: list[tuple]):
    ...
    def _buscar(self, dados: list, codigo: int) -> dict | None:
